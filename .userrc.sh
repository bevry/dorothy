...
if [[ "$OS" = "Darwin" ]]; then
	...
	alias fontinstall='brew cask install font-andale-mono font-droid-sans font-hasklig font-lato font-fira-code font-maven-pro font-fira-mono font-monoid font-montserrat font-open-sans font-ubuntu font-source-code-pro'
