...
alias caskinstall='brew cask install alfred google-chrome google-hangouts firefox lastfm picasa github skype screenflow sublime-text3 soundcleod xld slate'  #  google-drive dropbox bittorrent-sync
